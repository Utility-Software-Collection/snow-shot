		...
		(
			...
			if (group === AppSettingsGroup.Common) {
				...
				settings = {
					...
					videoRecordAudioTipDisabled:
						typeof newSettings?.videoRecordAudioTipDisabled === "boolean"
							? newSettings.videoRecordAudioTipDisabled
							: (prevSettings?.videoRecordAudioTipDisabled ?? false),
					enableLockDrawTool:
